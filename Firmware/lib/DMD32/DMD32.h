...
#define PIN_DMD_nOE                                                                                                    \
  16 // D22 active low Output Enable, setting this low lights all the LEDs in the selected rows. Can pwm it at very high
     // frequency for brightness control.
#define PIN_DMD_A 19      // D19
#define PIN_DMD_B 4       // D21
